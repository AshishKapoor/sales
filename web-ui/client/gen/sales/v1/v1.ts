...
export const useV1AccountsList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1AccountsList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1AccountsListKey() : null);
...
export const useV1ContactsList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1ContactsList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1ContactsListKey() : null);
...
export const getV1InteractionsListKey = () => [`/api/v1/interactions/`] as const;
...
export const useV1InteractionsList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1InteractionsList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1InteractionsListKey() : null);
...
export const useV1LeadsList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1LeadsList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1LeadsListKey() : null);
...
export const getV1OpportunitiesListKey = () => [`/api/v1/opportunities/`] as const;
...
export const useV1OpportunitiesList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1OpportunitiesList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1OpportunitiesListKey() : null);
...
export const useV1ProductsList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1ProductsList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1ProductsListKey() : null);
...
export const getV1QuoteLineItemsListKey = () => [`/api/v1/quote-line-items/`] as const;
...
export const useV1QuoteLineItemsList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1QuoteLineItemsList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1QuoteLineItemsListKey() : null);
...
export const useV1QuotesList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1QuotesList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1QuotesListKey() : null);
...
export const useV1TasksList = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1TasksList>>, TError> & { swrKey?: Key, enabled?: boolean },  }
) => {
  const {swr: swrOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1TasksListKey() : null);
